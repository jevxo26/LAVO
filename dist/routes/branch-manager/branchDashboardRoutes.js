...
const overviewController = __importStar(require("../../controllers/branch-manager/overviewController"));
const orderController = __importStar(require("../../controllers/branch-manager/orderController"));
const employeeController = __importStar(require("../../controllers/branch-manager/employeeController"));
const inventoryController = __importStar(require("../../controllers/branch-manager/inventoryController"));
const agentController = __importStar(require("../../controllers/branch-manager/agentController"));
const qrOrderController = __importStar(require("../../controllers/branch-manager/qrOrderController"));
const branchVendorController_1 = require("../../controllers/branch-manager/branchVendorController");

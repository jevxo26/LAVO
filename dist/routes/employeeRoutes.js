...
const employeeOrderController = __importStar(require("../controllers/employee/employeeOrderController"));
const router = express_1.default.Router();
router.use(authMiddleware_1.verifyToken);
router.use((0, roleMiddleware_1.restrictTo)('EMPLOYEE', 'Employee', 'BRANCH_MANAGER', 'Branch Manager', 'ADMIN', 'Admin', 'SUPER_ADMIN'));

...
const overviewController = __importStar(require("../../controllers/vendor/overviewController"));
const ordersController = __importStar(require("../../controllers/vendor/ordersController"));
const servicesController = __importStar(require("../../controllers/vendor/servicesController"));
const capacityController = __importStar(require("../../controllers/vendor/capacityController"));
const employeesController = __importStar(require("../../controllers/vendor/employeesController"));
const walletController = __importStar(require("../../controllers/vendor/walletController"));
const payoutsController = __importStar(require("../../controllers/vendor/payoutsController"));
const performanceController = __importStar(require("../../controllers/vendor/performanceController"));

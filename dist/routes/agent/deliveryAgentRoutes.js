...
const deliveryAgentController = __importStar(require("../../controllers/agent/deliveryAgentController"));
const availableDeliveriesController = __importStar(require("../../controllers/agent/availableDeliveriesController"));
const optimizeRouteController = __importStar(require("../../controllers/agent/optimizeRouteController"));
const verificationController = __importStar(require("../../controllers/agent/verificationController"));
const historyController = __importStar(require("../../controllers/agent/historyController"));
...
router.patch("/decline-pickup/:deliveryId", deliveryAgentController.declinePickup);
...
router.patch("/decline-delivery/:deliveryId", availableDeliveriesController.declineDelivery);

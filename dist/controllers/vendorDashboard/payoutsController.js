...
const payoutsService = __importStar(require("../../services/vendorDashboard/payoutsService"));
exports.getPayouts = (0, catchAsync_1.catchAsync)(async (req, res) => {
    ...
    (0, sendResponse_1.sendResponse)(res, { statusCode: 200, success: true, message: 'Payouts fetched successfully', data: result.data, meta: result.meta });
});
exports.requestPayout = (0, catchAsync_1.catchAsync)(async (req, res) => {
    ...
    (0, sendResponse_1.sendResponse)(res, { statusCode: 201, success: true, message: 'Payout request submitted', data });
});

...
class SMSService {
     ...
     */
    static async sendPickupOTP(phone, otpCode, orderNumber, customerName, agentPhone) {
     ...
     */
    static async sendDeliveryOTP(phone, otpCode, orderNumber, customerName, agentPhone) {
        const namePart = customerName ? `${customerName}, ` : '';
        const agentContact = agentPhone ? ` Agent Contact: ${agentPhone}.` : '';

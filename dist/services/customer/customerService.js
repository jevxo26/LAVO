    ...
    static async getOrCreateCustomer(userId) {
        ...
        if (!customer) {
            ...
            try {
                ...
                if ((createErr === null || createErr === void 0 ? void 0 : createErr.code) === 'P2002') {
        ...
        for (const group of SEED_GROUPS) {
            ...
            for (const svc of group.services) {
                ...
                await prisma.serviceAddon.createMany({
                    data: STANDARD_ADDONS.map((a) => (Object.assign(Object.assign({ serviceId: created.id }, a), { status: 'ACTIVE' }))),
                    skipDuplicates: true,
                });
            }
        }

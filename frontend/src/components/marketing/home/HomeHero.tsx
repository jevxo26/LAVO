...
function HeroSlideContent({ slide, sIdx }: { slide: HeroSlideData; sIdx: number }) {
        ...
        >
          ...
          {slide.badge && (
            <motion.div
              ...
              className="inline-flex items-center gap-2 rounded-full border border-primary/20 bg-primary/5 px-4 py-1.5 text-xs sm:text-sm font-medium text-primary w-fit shadow-sm"
            >
              <Sparkles size={16} />

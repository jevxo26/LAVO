...
export function SuperAdminOverview() {
  ...
  return (
    ...
    >
      ...
      <DashboardHeroBanner
        badge={{ label: "Super Admin Governance", liveLabel: "Platform Online" }}
        title="Executive Platform Control Center"
        subtitle="Multi-branch revenue analytics, instant vendor payout clearance, live security audit telemetry, and user access management."
        chips={[
          { label: "Gross Revenue",  value: totalRevenue },
          { label: "Total Outlets",  value: activeBranches + activeVendors },
        ]}
      />

...
export function NormalAdminOverview() {
  ...
  return (
    ...
    >
      ...
      <DashboardHeroBanner
        badge={{ label: "Operations Command", liveLabel: "Processing Live" }}
        title="Admin Operations Workstation"
        subtitle="Monitor real-time order intake, branch throughput, agent logistics dispatching, and resolve support tickets."
        chips={[

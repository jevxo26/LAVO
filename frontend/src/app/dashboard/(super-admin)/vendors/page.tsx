...
import { VendorTable } from "@/components/dashboard/(super-admin)/vendors/Table";
import { PendingVerifications } from "@/components/dashboard/(super-admin)/vendors/PendingVerifications";
import { PayoutRequests } from "@/components/dashboard/(super-admin)/vendors/PayoutRequests";

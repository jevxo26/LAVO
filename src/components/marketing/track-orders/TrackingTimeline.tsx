import { CheckCircle2, AlertCircle, Zap, Shirt, QrCode, Tag } from "lucide-react";
        ...
        <div className="rounded-2xl border border-slate-100 bg-white shadow-sm overflow-hidden">
          <div className="flex items-center justify-between border-b border-slate-100 px-6 py-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-sm font-extrabold text-slate-900">Itemized Garment Stages</h3>
                <p className="text-[11px] text-slate-400">Live processing status per garment &amp; QR label</p>
              </div>
            </div>
            <span className="inline-flex items-center gap-1 rounded-full bg-indigo-50 px-2.5 py-0.5 text-[10px] font-extrabold text-indigo-700">
                ...
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  <div className="min-w-0">
                    <div className="flex flex-wrap items-center gap-1.5">
                      <p className="text-xs font-bold text-slate-900 truncate">{garment.garmentName}</p>
                      <span className="inline-flex items-center gap-0.5 rounded-md bg-blue-50 border border-blue-200 px-1.5 py-0.5 text-[9px] font-extrabold text-blue-700">
                        ⚡ {garment.serviceName}
                      </span>
                    </div>

  ...
  return (
    <section className="relative overflow-hidden bg-background py-12 md:py-16 lg:py-20 ">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-6 text-center">
        ...
        >
          <Link  href="/book" className="flex items-center justify-center gap-2 rounded-xl bg-primary px-8 py-3.5 font-semibold text-primary-foreground shadow-lg transition-all duration-300 hover:-translate-y-0.5 hover:shadow-xl">
            Schedule Pickup
            <ArrowRight size={18} />
          </Link>

...
import { MapPin, Bell, Clock, QrCode, Wallet, Star, Play, BriefcaseBusiness } from "lucide-react";
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-16">
          ...
          >
                ...
                return (
                  <div key={idx} className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">{item.desc || item.content}</p>
                    </div>
                  </div>
                );
              })}
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4">
              <button className="flex items-center justify-center gap-3 border border-border bg-card hover:border-primary/30 hover:shadow-lg text-foreground px-6 py-3.5 rounded-xl font-medium transition-colors w-full sm:w-auto">
                <Play size={20} className="text-primary" />
                <div className="text-left flex flex-col">
                  <span className="text-[10px] leading-tight text-muted-foreground">Download on</span>
                  <span className="text-sm font-bold leading-tight">App Store</span>
                </div>
              </button>

              <button className="flex items-center justify-center gap-3 border border-border bg-card hover:border-primary/30 hover:shadow-lg text-foreground px-6 py-3.5 rounded-xl font-medium transition-colors w-full sm:w-auto">
                <svg className="w-6 h-6  text-primary" viewBox="0 0 24 24" fill="currentColor"><path d="M3.5 20.5v-17c0-.83.67-1.5 1.5-1.5h14c.83 0 1.5.67 1.5 1.5v17c0 .83-.67 1.5-1.5 1.5H5c-.83 0-1.5-.67-1.5-1.5zm15-1.5v-14H5.5v14H18.5z" /></svg>
                <div className="text-left flex flex-col">
                  <span className="text-[10px] leading-tight text-muted-foreground">Get it on</span>
          ...
          >
            ...
            <div className="w-[300px] h-[600px] bg-blue-600 rounded-[3rem] border-[10px] border-[#25324D] shadow-2xl relative overflow-hidden flex flex-col">
              ...
              <div className="bg-white h-[350px] rounded-t-3xl p-5 shadow-[0_-10px_40px_rgba(0,0,0,0.1)]">
                <div className="bg-slate-50 border border-slate-100 rounded-xl p-4 mb-4">
                  ...
                  <p className="text-[9px] text-muted-foreground">Step 4 of 7 · Washing</p>
                </div>

                <div className="flex justify-between items-center mb-6">
                  <div className="flex flex-col items-center">
                    <div className="w-10 h-10 bg-slate-50 rounded-full flex items-center justify-center text-muted-foreground mb-1"><MapPin size={16} /></div>
                    <span className="text-[9px] text-slate-500">Book</span>
                  </div>
                  <div className="flex flex-col items-center">
                    <div className="w-10 h-10 bg-slate-50 rounded-full flex items-center justify-center text-muted-foreground mb-1"><QrCode size={16} /></div>
                  ...
                  <div className="flex flex-col items-center">
                    <div className="w-10 h-10 bg-slate-50 rounded-full flex items-center justify-center text-muted-foreground mb-1"><Bell size={16} /></div>

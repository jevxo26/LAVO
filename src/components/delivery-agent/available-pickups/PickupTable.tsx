    ...
    return (
        <div className="rounded-xl border bg-white p-5 space-y-5">
            ...
            >
                <div className="grid grid-cols-2 gap-4 text-sm">
                    ...
                    <div>
                        ...
                        <p className="font-semibold text-indigo-600">{selectedPickup?.totalGarments ?? 1} Garment(s)</p>
                    </div>
            ...
            <AcceptDialog
                open={open}
                title="Accept Pickup"
                description={`Are you sure you want to accept pickup for Order #${selectedPickup?.orderId} (${selectedPickup?.totalGarments ?? 1} item(s))?`}
                onCancel={() => {
                    setOpen(false);
                    setSelectedPickup(null);
                }}

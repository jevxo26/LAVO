...
import { Headphones, Ticket as TicketIcon, Star, Megaphone } from "lucide-react";
  ...
  return (
    <div className="p-6 md:p-8 max-w-7xl mx-auto w-full space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold text-slate-900 tracking-tight">Support & Operations Center</h1>
          <p className="text-slate-400 text-sm mt-0.5">Manage customer support tickets, moderate reviews, and publish announcements.</p>
        </div>
      </div>

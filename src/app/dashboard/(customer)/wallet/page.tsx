...
function WalletBalanceCard({ balance, onTopUp }: { balance: number; onTopUp: () => void }) {
  return (
    <motion.div
      whileHover={{ y: -3 }}
      className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900 p-7 text-white shadow-2xl border border-blue-900/40"
    >
      <div className="pointer-events-none absolute inset-0 opacity-20">
        <div className="absolute -top-12 -right-12 h-56 w-56 rounded-full bg-blue-500 blur-3xl" />
        <div className="absolute -bottom-10 -left-10 h-40 w-40 rounded-full bg-cyan-500 blur-3xl" />
      </div>
      ...
      <div className="relative z-10 flex flex-col gap-6">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 pt-2 border-t border-white/10">
          <div className="flex items-center gap-2">
            <span className="flex items-center gap-1.5 rounded-full bg-white/10 px-3 py-1 text-[11px] font-extrabold text-cyan-200 backdrop-blur-md">
          ...
          <Button
            onClick={onTopUp}
            className="h-9 px-4 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-extrabold text-xs shadow-md shadow-blue-600/30 gap-1.5 transition-all hover:scale-[1.02]"
          >
...
function LoyaltyCard({ points }: { points: number }) {
  return (
    <motion.div
      whileHover={{ y: -3 }}
      className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-950 p-7 text-white shadow-2xl border border-blue-800/40"
    >
      <div className="pointer-events-none absolute inset-0 opacity-20">
        <div className="absolute -top-12 -right-12 h-56 w-56 rounded-full bg-cyan-400 blur-3xl" />
      ...
      <div className="relative z-10 flex flex-col gap-6">
        <div className="flex items-start justify-between">
          <div>
            <p className="text-[11px] font-black uppercase tracking-widest text-cyan-300">Loyalty Rewards Tier</p>
            <p className="mt-2 text-4xl font-black tracking-tight leading-none text-white">
              {points.toLocaleString()} <span className="text-2xl font-black text-cyan-300">PTS</span>
            </p>
          </div>
          <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-white/10 backdrop-blur-md shadow-inner">
      ...
      <DialogContent className="sm:max-w-md rounded-3xl border border-slate-200 dark:border-slate-800 dark:bg-slate-900">
        ...
        <form onSubmit={handleSubmit} className="space-y-5 pt-2">
          ...
          <Button
            ...
            className="w-full rounded-2xl bg-blue-600 hover:bg-blue-500 text-white font-black h-11 gap-2 shadow-lg shadow-blue-600/30 transition-all"
          >
            {loading ? (
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <motion.div whileHover={{ y: -2 }} className="flex items-center gap-4 rounded-3xl border border-slate-200/80 bg-white p-5 shadow-sm dark:bg-slate-900 dark:border-slate-800">
          <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-blue-50 text-blue-600 dark:bg-blue-950/50 dark:text-blue-400">

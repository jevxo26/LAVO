  ...
  return (
    ...
    >
            ...
            {tickets.length > 0 && (
              <>
                <div className="rounded-2xl bg-white/10 border border-white/15 backdrop-blur-xl px-4 py-3 text-center min-w-[90px] shadow-inner">
                  <p className="text-indigo-200 text-[10px] font-black uppercase tracking-wider">Open</p>
                  <p className="text-white font-black text-2xl mt-0.5">{openCount}</p>
                </div>
                <div className="rounded-2xl bg-white/10 border border-white/15 backdrop-blur-xl px-4 py-3 text-center min-w-[90px] shadow-inner">
                  <p className="text-indigo-200 text-[10px] font-black uppercase tracking-wider">Solved</p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <a
          href="tel:16262"
          className="group flex items-center gap-4 rounded-3xl border border-blue-200/80 bg-gradient-to-r from-blue-50/70 via-white to-sky-50/70 p-5 shadow-sm hover:shadow-md hover:border-blue-300 transition-all dark:bg-slate-900 dark:border-slate-800"
        >
        ...
        <button
          onClick={() => setDialogOpen(true)}
          className="group flex items-center gap-4 rounded-3xl border border-indigo-200/80 bg-gradient-to-r from-indigo-50/70 via-white to-purple-50/70 p-5 shadow-sm hover:shadow-md hover:border-indigo-300 transition-all text-left dark:bg-slate-900 dark:border-slate-800"
        >
          <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-indigo-600 text-white shadow-md shadow-indigo-500/20 group-hover:scale-110 transition-transform">
            <Headphones size={22} />
          </div>
          <div className="min-w-0 flex-1">
          ...
          <ArrowRight size={15} className="text-slate-300 group-hover:text-indigo-600 group-hover:translate-x-1 transition-all" />
        </button>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-12 items-start">
        ...
        <div className="lg:col-span-7 rounded-3xl border border-slate-200/80 bg-white shadow-sm overflow-hidden dark:bg-slate-900 dark:border-slate-800">
          <div className="flex items-center justify-between border-b border-slate-100 px-6 py-5 dark:border-slate-800">
            ...
            <span className="rounded-full bg-indigo-50 dark:bg-indigo-950/50 px-3 py-1 text-xs font-black text-indigo-600 dark:text-indigo-300">
          ...
          <div className="p-5">
            {tickets.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-14 text-center">
                <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-3xl bg-indigo-50 text-indigo-500 dark:bg-indigo-950/50">
                  <Inbox size={28} />
                </div>
                ...
                <Button
                  onClick={() => setDialogOpen(true)}
                  className="mt-5 h-10 px-5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-black gap-2 shadow-lg shadow-indigo-600/20"
                >

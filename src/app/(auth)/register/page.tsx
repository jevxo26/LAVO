    ...
    return (
        <div className="min-h-screen bg-white ">
            ...
            >
                ...
                <div
                    className=" relative hidden min-h-screen overflow-hidden
                        bg-gradient-to-br
                        from-blue-50
                        via-white
                        to-cyan-50
                ...
                >
                    ...
                    {/* Content */}
                    <div className="relative z-10 flex min-h-screen w-full items-center justify-center px-10">
                        <motion.div
                            ...
                            >
                                ...
                                <div className="relative z-10">
                                    ...
                                    <p className="mx-auto mt-3 max-w-sm text-sm leading-6 text-slate-500">
                                        Join LAUNDRIX to book laundry services, track
                                        your orders, and enjoy a smarter laundry experience.
                                    </p>
                ...
                <motion.div
                    ...
                    className="flex min-h-screen min-w-0 items-center justify-center overflow-x-hidden bg-slate-50 px-4 py-6 sm:px-6"
                >
                    <div className="w-full min-w-0 max-w-lg overflow-hidden rounded-3xl border border-slate-200 bg-white p-5 shadow-xl sm:p-5">
